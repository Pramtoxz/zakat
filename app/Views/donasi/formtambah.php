    ...
    <div class="col-md-12   ">
        <div class="card card-success">
            <div class="card-header">
                <h3 class="card-title">Tambah Data Donasi</h3>
            </div>
            <div class="card-body">
                <?= form_open('donasi/save', ['id' => 'formtambahdonasi', 'enctype' => 'multipart/form-data']) ?>
                <?= csrf_field() ?>
                <div class="row">
                    <div class="col-sm-12">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="nominal" name="nominal" class="form-control" placeholder="Masukkan nominal donasi">
