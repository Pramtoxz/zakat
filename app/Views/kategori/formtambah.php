        ...
        <div class="col-md-12">
            <div class="card card-teal shadow-lg">
                <div class="card-header">
                    <h3 class="card-title"><i class="fas fa-plus-circle mr-2"></i> Tambah Data Kategori</h3>
                </div>

                <div class="card-body p-4">
                    <?= form_open('kategori/save', ['id' => 'formtambahkategori']) ?>
                    <?= csrf_field() ?>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="hidden" class="form-control" id="idkategori" name="idkategori" value="<?= $next_number ?>" readonly>
