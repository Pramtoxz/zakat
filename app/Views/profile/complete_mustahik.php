...
<body class="hero-gradient min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-2xl">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-bold text-white mb-2">Lengkapi Profile Mustahik</h1>
        ...
        <div class="glass-effect rounded-2xl shadow-2xl p-8">
            ...
            <form action="<?= site_url('profile/save/mustahik') ?>" method="POST" class="space-y-6">
                <!-- Nama Lengkap -->
                <div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-blue-700 text-sm">
                                ...
                                Data yang Anda berikan akan digunakan untuk verifikasi dan penyaluran bantuan.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col space-y-4">
                    ...
                    <div class="text-center">
                        <p class="text-sm text-gray-600">
                            ...
                            Data Anda akan dijaga kerahasiaannya dan hanya digunakan untuk keperluan administrasi
                        </p>
                    </div>
                </div>
            </form>
