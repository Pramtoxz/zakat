...
<head>
    ...
    <title>Kalkulator Zakat - <?= $title ?? 'Dashboard' ?></title>
        ...
        <div class="max-w-4xl mx-auto px-4">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 mb-8">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-2">Hitung zakat Anda sesuai ketentuan syariah berdasarkan standar BAZNAS</p>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="bg-blue-50 border-l-4 border-blue-400 p-4 rounded">
                            <p class="text-blue-800 text-sm">
                                <strong>Ketentuan:</strong> Nishab zakat penghasilan sebesar 85 gram emas per tahun (setara Rp 85.000.000 per tahun atau Rp 7.083.333 per bulan). 
                    ...
                    <div class="mb-6">
                        ...
                        <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded">
                            <p class="text-yellow-800 text-sm">
                                <strong>Ketentuan:</strong> Nishab zakat emas sebesar 85 gram emas (setara Rp 85.000.000). 
            ...
            <div class="mt-8 text-center">
                <a href="<?= base_url('dashboard/donatur/zakat/form') ?>" 
                   class="inline-flex items-center px-6 py-3 bg-primary text-white rounded-lg hover:bg-green-600 transition-colors">
