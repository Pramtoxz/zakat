        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h1 class="text-lg font-bold text-gray-900">Edit Profile Mustahik</h1>
        ...
        <div class="bg-white overflow-hidden shadow rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                <h3 class="text-lg leading-6 font-medium text-gray-900 mb-6">
                    <i class="fas fa-user-edit mr-2"></i>Edit Profile Mustahik
                </h3>

                <form action="<?= base_url('dashboard/mustahik/update-profile') ?>" method="POST" class="space-y-6">
                    <!-- Nama Lengkap -->
                    <div>
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            required><?= old('alamat', $mustahik['alamat']) ?></textarea>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <label class="flex items-center space-x-3 cursor-pointer">
                                <input 
                                    ...
                                    name="jenkel" 
                                    value="L" 
                                    <?= old('jenkel', $mustahik['jenkel']) === 'L' ? 'checked' : '' ?>
                            ...
                            <label class="flex items-center space-x-3 cursor-pointer">
                                <input 
                                    ...
                                    name="jenkel" 
                                    value="P" 
                                    <?= old('jenkel', $mustahik['jenkel']) === 'P' ? 'checked' : '' ?>
                                    class="w-4 h-4 text-primary border-gray-300 focus:ring-primary"
                                    required>
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            id="tgllahir" 
                            name="tgllahir" 
                            value="<?= old('tgllahir', $mustahik['tgllahir']) ?>"
                            class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-primary focus:ring-2 focus:ring-primary focus:ring-opacity-20 transition duration-200"
                            required>
                    ...
                    <div class="bg-blue-50 border-l-4 border-blue-400 p-4 rounded-lg">
                        <div class="flex items-start">
                            ...
                            <div>
                                <h3 class="text-blue-800 font-medium mb-1">Penting untuk Mustahik</h3>
                                <p class="text-blue-700 text-sm">
                                    Pastikan data yang Anda masukkan akurat dan terkini. Data ini akan digunakan untuk verifikasi 
                                    dan proses penyaluran bantuan zakat kepada Anda.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 pt-6">
                        ...
                        <a href="<?= base_url('dashboard/mustahik') ?>" 
