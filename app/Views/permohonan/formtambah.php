...
<div class="row">
    <div class="col-md-8">
        <div class="card card-success">
            ...
            <div class="card-body">
                <?= form_open('permohonan/save', ['id' => 'formtambahpermohonan', 'enctype' => 'multipart/form-data']) ?>
                <?= csrf_field() ?>
                
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="idpermohonan">ID Permohonan <span class="text-danger">*</span></label>
                            <input type="text" id="idpermohonan" name="idpermohonan" class="form-control" value="<?= $next_number ?>" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <select id="id_mustahik" name="id_mustahik" class="form-control">
                                ...
                                <?php foreach ($mustahiks as $mustahik): ?>
                                    <option value="<?= $mustahik['id_mustahik'] ?>"><?= $mustahik['nama'] ?> - <?= $mustahik['id_mustahik'] ?></option>
                                <?php endforeach; ?>
                            </select>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="jenisbantuan" name="jenisbantuan" class="form-control" placeholder="Masukkan jenis bantuan">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="date" id="tglpengajuan" name="tglpengajuan" class="form-control" value="<?= date('Y-m-d') ?>">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted">Format: PDF saja (Maksimal: 5MB)</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <textarea id="alasan" name="alasan" class="form-control" rows="4" placeholder="Jelaskan alasan permohonan bantuan"></textarea>
...
$(document).ready(function() {
    $('#formtambahpermohonan').submit(function(e) {
        e.preventDefault();
