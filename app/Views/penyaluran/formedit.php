    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-success shadow-lg">
                ...
                <?= form_open('penyaluran/updatedata/' . $penyaluran['id'], ['id' => 'formeditpenyaluran', 'enctype' => 'multipart/form-data']) ?>
                <?= csrf_field() ?>
                
                    <div class="row justify-content-center">
                        <div class="col-md-10">
                            <input type="hidden" id="id" name="id" value="<?= $penyaluran['id'] ?>">
                        ...
                        <option value="zakat" <?= $penyaluran['jenisdana'] == 'zakat' ? 'selected' : '' ?>>Zakat</option>
                        <option value="donasi" <?= $penyaluran['jenisdana'] == 'donasi' ? 'selected' : '' ?>>Donasi</option>
                    </select>
                            ...
                            <div class="form-group row mb-4" id="input-permohonan" style="display: none;">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                                                <input type="hidden" id="idpermohonan" name="idpermohonan" class="form-control" readonly value="<?= $penyaluran['idpermohonan'] ?? '' ?>">
                        <input type="text" id="namapermohonan" name="namapermohonan" class="form-control" placeholder="Pilih permohonan..." readonly value="<?= isset($penyaluran['kategoriasnaf']) ? $penyaluran['kategoriasnaf'] . ' - ' . $penyaluran['nama_mustahik'] : '' ?>">
                            ...
                            <div class="form-group row mb-4" id="input-mustahik" style="display: none;">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                                                <input type="hidden" id="id_mustahik" name="id_mustahik" class="form-control" readonly value="<?= $penyaluran['id_mustahik'] ?? '' ?>">
                        <input type="text" id="namamustahik" name="namamustahik" class="form-control" placeholder="Pilih mustahik..." readonly value="<?= $penyaluran['nama_mustahik'] ?? '' ?>">
                                        <div class="input-group-append">
                            ...
                            <option value="<?= $program['idprogram'] ?>" <?= $penyaluran['idprogram'] == $program['idprogram'] ? 'selected' : '' ?>><?= $program['namaprogram'] ?></option>
                        <?php endforeach; ?>
                                    </select>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <input type="number" id="nominal" name="nominal" class="form-control" placeholder="Masukkan nominal dana" min="0" value="<?= $penyaluran['nominal'] ?? '' ?>">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="date" id="tglpenyaluran" name="tglpenyaluran" class="form-control" value="<?= $penyaluran['tglpenyaluran'] ?? date('Y-m-d') ?>">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <textarea id="deskripsi" name="deskripsi" class="form-control" rows="4" placeholder="Keterangan tambahan (opsional)"><?= $penyaluran['deskripsi'] ?? '' ?></textarea>
...
$(function() {
    ...
    $('#formeditpenyaluran').submit(function(e) {
        e.preventDefault();
    ...
    // Set initial state berdasarkan jenisdana yang sudah dipilih
    $(document).ready(function() {
        handleJenisDanaChange();
    });
