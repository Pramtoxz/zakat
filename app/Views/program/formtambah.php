...
<div class="row">
    <div class="col-md-8">
        <div class="card card-success">
            ...
            <div class="card-body">
                <?= form_open('program/save', ['id' => 'formtambahprogram', 'enctype' => 'multipart/form-data']) ?>
                <?= csrf_field() ?>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="idprogram" name="idprogram" class="form-control" value="<?= $next_number ?>" readonly>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="namaprogram" name="namaprogram" class="form-control" placeholder="Masukkan nama program">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="date" id="tglmulai" name="tglmulai" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="date" id="tglselesai" name="tglselesai" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <textarea id="deskripsi" name="deskripsi" class="form-control" rows="4" placeholder="Masukkan deskripsi program"></textarea>
    ...
    <div class="col-md-4">
        <div class="card bg-success" style="padding-left: 10px; padding-right: 10px; height: 362px;">
            ...
            <div class="card-body" style="overflow: hidden;">
                <img id="fotoPreview" src="#" alt="Preview Foto" class="img-fluid" style="max-width: 100%; max-height: 100%; display: none;">
            </div>
        </div>
