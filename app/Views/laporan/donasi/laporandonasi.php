            ...
            <div class="row-sm-12" id="printHalaman">
                ...
                <div class="d-flex justify-content-center align-items-center text-center">
                    ...
                    <div>
                        ...
                        <b style="font-size: 20px; font-family: 'Times New Roman'; margin-bottom: 0; text-decoration: underline;">Laporan Donasi</b>
                    </div>
                </div>
                <div class="tabelObat">
...
<script>
    function ViewLaporanSemua() {
        $.ajax({
            type: "get",
            url: "<?= base_url('laporan/donasi/view') ?>",
            dataType: "JSON",
    ...
    function ViewLaporanTanggal() {
        ...
        if (tglmulai == '') {
            ...
            $.ajax({
                type: "POST",
                url: "<?= base_url('laporan/donasi/viewtanggal') ?>",
                data: {
                    tglmulai: tglmulai,
                    tglakhir: tglakhir,
                },
    ...
    function ViewLaporanPerbulan() {
        ...
        if (bulan == '') {
            ...
            $.ajax({
                type: "POST",
                url: "<?= base_url('laporan/donasi/viewbulan') ?>",
                data: {
                    bulan: bulan,
                    tahun: tahun,
                },
