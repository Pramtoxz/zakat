...
<div class="col-md-12">
    <div class="card card-success">
        <div class="card-header">
            <h3 class="card-title">Laporan Mustahik</h3>
            <!-- /.card-tools -->
        </div>
        <!-- /.card-header -->
        <div class="card-body">
                    ...
                    <div>
                        <div style="display: flex; align-items: center; justify-content: center; margin-bottom: 20px; margin-left: -150px;">
                            ...
                            <div style="text-align: center; margin-left: 60px;">
                                <p style="font-size: 28px; font-family: 'Times New Roman'; margin-bottom: 0;"><b>Zakat</b></p>
                        ...
                        <b style="font-size: 20px; font-family: 'Times New Roman'; margin-bottom: 0; text-decoration: underline;">Laporan Mustahik</b>
                    </div>
                </div>
                <div class="tabelAset">
                </div>
            ...
            margin-top: 20px;">
                    ...
                    <div style="text-align: center;">
                        ...
                        <p style="margin-top: 5rem; font-size: 18px; font-family: 'Times New Roman'; margin-bottom: 0;">Lembaga Mitra Pengelola Zakat (MPZ) Alumni FK Unand Padang</p>
                    </div>
                </div>
            </div>
...
<script>
    function ViewLaporanSemua() {
        $.ajax({
            type: "get",
            url: "<?= base_url('laporan-users/mustahik/view') ?>",
            dataType: "JSON",
