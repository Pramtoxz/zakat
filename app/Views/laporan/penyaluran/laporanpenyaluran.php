...
<div class="col-md-12">
    <div class="card card-success">
        <div class="card-header">
            <h3 class="card-title">Laporan Penyaluran Dana</h3>
            <!-- /.card-tools -->
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        <label>Laporan Penyaluran Zakat</label>
                        <div class="col-10 input-group">
                            <span class="input-group-append">
                                <button class="btn btn-success" onclick="ViewLaporanZakat()">
                                    <i class="fas fa-mosque mr-1"></i>View Laporan Zakat
                                </button>
                            </span>
                        </div>
                    </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label>Laporan Penyaluran Donasi</label>
                        <div class="col-10 input-group">
                            <span class="input-group-append">
                                <button class="btn btn-primary" onclick="ViewLaporanDonasi()">
                                    <i class="fas fa-hand-holding-heart mr-1"></i>View Laporan Donasi
                                </button>
                            </span>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        <div class="col-10 input-group">
                            <span class="input-group-append">
                                <button class="btn btn-info" onclick="PrintLaporan()"><i class="fas fa-print"></i> Print Laporan</button>
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-2">
                    <div class="form-group">
                        <div>Jenis Dana <span class="text-danger">*</span></div>
                        <select class="form-control" id="jenisdana" name="jenisdana">
            ...
            <div class="row">
                <div class="col-sm-2">
                    <div class="form-group">
                        <div>Jenis Dana <span class="text-danger">*</span></div>
                        <select class="form-control" id="jenisdana2" name="jenisdana2">
                            <option value="">-- Pilih --</option>
                            <option value="zakat">Zakat</option>
                            <option value="donasi">Donasi</option>
                        </select>
            ...
            <div class="row-sm-12" id="printHalaman">
                ...
                <div class="d-flex justify-content-center align-items-center text-center">
                    ...
                    <div>
                        ...
                        <b style="font-size: 20px; font-family: 'Times New Roman'; margin-bottom: 0; text-decoration: underline;">Laporan Penyaluran Dana</b>
                    </div>
                </div>
                <div class="tabelPenyaluran">
...
<script>
    function ViewLaporanZakat() {
        $.ajax({
            type: "get",
            url: "<?= base_url('laporan/penyaluran/viewzakat') ?>",
            dataType: "JSON",
            success: function(response) {
                if (response.data) {
                    $('.tabelPenyaluran').html(response.data);
                }
            }
        });
    }

    function ViewLaporanDonasi() {
        $.ajax({
            type: "get",
            url: "<?= base_url('laporan/penyaluran/viewdonasi') ?>",
            dataType: "JSON",
            success: function(response) {
                if (response.data) {
                    $('.tabelPenyaluran').html(response.data);
    ...
    function ViewLaporanTanggal() {
        let jenisdana = $('#jenisdana').val();
        let tglmulai = $('#tglmulai').val();
        let tglakhir = $('#tglakhir').val();
        
        if (jenisdana == '') {
            toastr.error('Jenis Dana Belum Dipilih !!!');
        } else if (tglmulai == '') {
            ...
            $.ajax({
                type: "POST",
                url: "<?= base_url('laporan/penyaluran/viewtanggal') ?>",
                data: {
                    jenisdana: jenisdana,
                    tglmulai: tglmulai,
                    tglakhir: tglakhir,
    ...
    function ViewLaporanPerbulan() {
        ...
        if (jenisdana == '') {
            ...
            $.ajax({
                type: "POST",
                url: "<?= base_url('laporan/penyaluran/viewbulan') ?>",
                data: {
                    jenisdana: jenisdana,
                    bulan: bulan,
                    tahun: tahun,
