    ...
    <div class="col-md-12   ">
        <div class="card card-success">
            <div class="card-header">
                <h3 class="card-title">Edit Data Zakat</h3>
            </div>
            <div class="card-body">
            <?= form_open('zakat/updatedata/' . $zakat['idzakat'], ['id' => 'formeditzakat']) ?>
            <?= csrf_field() ?>
                <div class="row">
                    <div class="col-sm-12">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <select id="id_donatur" name="id_donatur" class="form-control">
                                ...
                                <?php foreach ($donaturs as $donatur): ?>
                                    <option value="<?= $donatur['id_donatur'] ?>" <?= $zakat['id_donatur'] == $donatur['id_donatur'] ? 'selected' : '' ?>>
                                        <?= $donatur['nama'] ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="nominal" name="nominal" class="form-control" placeholder="Masukkan nominal zakat" value="<?= $zakat['nominal'] ?>">
                        ...
                        <div class="form-group">
                            ...
                            <select id="jeniszakat" name="jeniszakat" class="form-control">
                                ...
                                <?php foreach ($programs as $program): ?>
                                    <option value="<?= $program['idprogram'] ?>" <?= $zakat['jeniszakat'] == $program['idprogram'] ? 'selected' : '' ?>>
                                        <?= $program['namaprogram'] ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
...
<?= $this->section('script') ?>
<script>
    $('#formeditzakat').submit(function(e) {
        e.preventDefault();
